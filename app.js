...
function fmt(n){return n===null||n===undefined||Number.isNaN(n)?'-':Number(n).toLocaleString('en-US',{minimumFractionDigits:0,maximumFractionDigits:3})}
function csvNum(n){return n===null||n===undefined||Number.isNaN(n)?'':String(Number(n.toFixed? n.toFixed(3): n)).replace(/\.?0+$/,'')}
